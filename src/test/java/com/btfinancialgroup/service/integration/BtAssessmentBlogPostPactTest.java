...
public class BtAssessmentBlogPostPactTest {
	...
	public RequestResponsePact createPact(PactDslWithProvider builder) {
		...
		DslPart consumerExpectation = new PactDslJsonBody().integerType("id", 1).integerType("userId", 1)
				.stringType("title", "How to write a Pact Test");

		return builder.given("There exists a Blog Post for id 1").uponReceiving("A request for id 1").path("/users/1")
